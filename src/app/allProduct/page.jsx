...
export default function AllProducts() {
    ...
    return (
        <>
            <div className="relative min-w-full h-full bg-cover bg-center py-[10vw] sm:py-[2vw] md:py-[2vw] lg:py-[1vw] bg-gradient-to-r from-slate-950 via-white/10 to-slate-950">
