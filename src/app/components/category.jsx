                ...
                <div  className="relative grid grid-cols-2 sm:grid-cols-2  md:grid-cols-3  lg:grid-cols-4  gap-[2vw] sm:gap-[1vw] md:gap-[1vw] lg:gap-[2vw]  overflow-x-hidden py-[1vw] px-[4vw]  justify-center items-center">
                    {category?.map((item,i) => (
                        ...
                        >
                            ...
                            <Link href={`/categories/${item}`} key={item.id} className="relative flex w-[15vw] sm:w-[10vw]  md:w-[10vw] lg:w-[8vw] h-[4vh]  sm:h-[3vh] md:h-[3vh] lg:h-[4vh] justify-center items-center border rounded-2xl border-black opacity-0 group-hover:opacity-100  transition-opacity duration-700 transform translate-y-[3vw]">
